---
title: "Building Reusable Logic with Custom Hooks in React"
sidebarTitle: "Custom Hooks"
description: "Custom hooks encapsulate reusable logic outside components. Learn how useFetch wraps the Fetch API and returns an async function you can call anywhere."
---
